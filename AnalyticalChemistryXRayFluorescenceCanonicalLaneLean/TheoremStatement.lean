import AnalyticalChemistryXRayFluorescenceCanonicalLaneLean.ReviewerBridge
...
def sourceTheoremStatement : TheoremStatement := {
  ...
  manifoldConstrainedStatement := "XRF fluorescence yield model constrained by fundamental parameters, source constants, and reviewer bridge",
